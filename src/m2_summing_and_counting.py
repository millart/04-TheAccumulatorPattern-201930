...
def run_test_sum_more_cosines():
    ...
    # Test 4:
    expected = -0.235818462  # This is APPROXIMATELY the correct answer.
    answer = sum_more_cosines(-5, 0)
    ...
    # Test 5:
    expected = 0.0977212875  # This is APPROXIMATELY the correct answer.
    answer = sum_more_cosines(20, 27)
...
def sum_more_cosines(m, n):
    ...
    for k in range(n - m + 1):
        add_this = math.cos(k + m)
        total = total + add_this
...
def run_test_count_sines_from():
    ...
    # Test 5:
    expected = 4
    answer = count_sines_from(41, 44)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 1
    answer = count_sines_from(-13, -11)
    print('Test 6 expected:', expected)
    print('       actual:  ', answer)

    # Test 7:
    expected = 3
    answer = count_sines_from(11, 13)
