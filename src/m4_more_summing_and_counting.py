...
def run_test_sum_from():
    ...
    # Personal note: ORACLE sums all the numbers in the range (excluding the last number)
    # (when only the end number is given, zero is the default start)
...
def run_test_count_cosines_from():
    ...
    # Test 2:
    expected = 4
    answer = count_cosines_from(0, 7, 0.50)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    # Test 3:
    expected = 3
    answer = count_cosines_from(-2, 2, 0.00)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    # Test 4:
    expected = 5
    answer = count_cosines_from(2, 8, -0.45)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 0
    answer = count_cosines_from(10, 11, 0.10)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 1
    answer = count_cosines_from(-13, -12, 0.90)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 3:
    expected = 0.95  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(3, 6)
    print('Test 3 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 4:
    expected = 0.5517607392  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(10, 16)
